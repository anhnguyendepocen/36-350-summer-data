New York Air Quality Measurements (Altered)
...
A data frame with 154 observations on 4 variables.
...
The data were obtained from the New York State Department of Conservation (ozone
data) and the National Weather Service (meteorological data).
